...
import com.aurora.client.MainActivity
import com.aurora.client.R
import com.aurora.client.core.MihomoCore
...
class AuroraVpnService : VpnService() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.aurora.client.START"
        private const val ACTION_STOP = "com.aurora.client.STOP"
